...
const AmplifyAuthenticator = class extends HTMLElement {
    ...
    render() {
        return (h(Host, null, this.toastMessage ? (h("amplify-toast", { message: this.toastMessage, handleClose: () => {
                this.toastMessage = '';
            }, "data-test": "authenticator-error" })) : null, this.authState === AuthState.SignedIn ? ([h("slot", { name: "greetings" }), h("slot", null)]) : (h("div", { class: "auth-container" }, this.getSlotWithAuthComponent(this.authState)))));
    }
    get el() { return this; }
...
const AmplifyAuthenticator$1 = /*@__PURE__*/proxyCustomElement(AmplifyAuthenticator, [1,"amplify-authenticator",{"initialAuthState":[1,"initial-auth-state"],"federated":[16],"usernameAlias":[1,"username-alias"],"handleAuthStateChange":[16],"authState":[32],"authData":[32],"toastMessage":[32]}]);
