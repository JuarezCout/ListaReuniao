...
const helpers = require('./helpers-744a1aad.js');
const authHelpers = require('./auth-helpers-960194ee.js');
...
const AmplifyAuthenticator = class {
    ...
    render() {
        return (index.h(index.Host, null, this.toastMessage ? (index.h("amplify-toast", { message: this.toastMessage, handleClose: () => {
                this.toastMessage = '';
            }, "data-test": "authenticator-error" })) : null, this.authState === authTypes.AuthState.SignedIn ? ([index.h("slot", { name: "greetings" }), index.h("slot", null)]) : (index.h("div", { class: "auth-container" }, this.getSlotWithAuthComponent(this.authState)))));
    }
